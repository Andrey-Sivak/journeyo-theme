...
>
    <div class="<?php echo $base_class . '__wrap'; ?>">
        ...
        <?php if (!empty($title)) : ?>
            <h2 class="<?php echo $base_class . '__title jn-animate'; ?>" id="team-section-title">
                        ...
                        <div class="<?php echo $base_class . '__item-wrap'; ?>">
                            <?php if (!empty($item['photo']) && is_array($item['photo']) && !empty($item['photo']['id'])) : ?>
                                <figure class="<?php echo $base_class . '__item-photo'; ?>" itemprop="image">
                                    <svg aria-hidden="true" viewBox="0 0 200 200" fill="none"
                            ...
                            <?php if (!empty($item['name'])) : ?>
                                <h3 class="<?php echo $base_class . '__item-name'; ?>" itemprop="name">
                                    <?php echo wp_kses_post($item['name']); ?>
                                </h3>
                            <?php endif; ?>
                            <?php if (!empty($item['position'])) : ?>
                                <p class="<?php echo $base_class . '__item-position'; ?>" itemprop="jobTitle">
                                    <?php echo wp_kses_post($item['position']); ?>
                                </p>
                            <?php endif; ?>
                            <?php if (!empty($item['text'])) : ?>
                                <p class="<?php echo $base_class . '__item-text'; ?>" itemprop="description">
